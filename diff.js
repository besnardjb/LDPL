...
function render_diff()
{
	...
	fill_diff_table( profile_dat , "total_time");
	
	$("#DIFF").append("<h3>Min Time Difference</h3>");
	fill_diff_table( profile_dat , "min_time");
	
	$("#DIFF").append("<h3>Max Time Difference</h3>");
	fill_diff_table( profile_dat , "max_time");
	
	$("#DIFF").append("<h3>Calls Difference</h3>");
	fill_diff_table( profile_dat , "call");
}
